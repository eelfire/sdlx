...
module MemLaneSwitch (
  ...
  wire [7:0] dataInLane0 = memoryDataIn[7:0];
  wire [7:0] dataInLane1 = memoryDataIn[15:8];
  wire [7:0] dataInLane2 = memoryDataIn[23:16];
  wire [7:0] dataInLane3 = memoryDataIn[31:24];
  ...
  wire [7:0] dataOutLane0 = memoryDataOut[7:0];
  wire [7:0] dataOutLane1 = memoryDataOut[15:8];
  wire [7:0] dataOutLane2 = memoryDataOut[23:16];
  wire [7:0] dataOutLane3 = memoryDataOut[31:24];
