...
set_property PACKAGE_PIN U2 [get_ports {digitEn[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {digitEn[0]}]
set_property PACKAGE_PIN U4 [get_ports {digitEn[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {digitEn[1]}]
set_property PACKAGE_PIN V4 [get_ports {digitEn[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {digitEn[2]}]
set_property PACKAGE_PIN W4 [get_ports {digitEn[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {digitEn[3]}]


##Buttons
set_property PACKAGE_PIN T17 [get_ports {pushButtons[0]}]		
	set_property IOSTANDARD LVCMOS33 [get_ports {pushButtons[0]}]
set_property PACKAGE_PIN W19 [get_ports {pushButtons[1]}]						
 	set_property IOSTANDARD LVCMOS33 [get_ports {pushButtons[1]}]
set_property PACKAGE_PIN U18 [get_ports {pushButtons[2]}]						
...
set_property PACKAGE_PIN U17 [get_ports {pushButtons[4]}]						
